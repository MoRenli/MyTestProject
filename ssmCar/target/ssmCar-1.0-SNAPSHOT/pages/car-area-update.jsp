...
<div style="height: 619px;background-color: #ecf0f5">
    ...
    <form action="${pageContext.request.contextPath}/areamanager/areaManagerUpdate">
        <input type="hidden" name="id" value="${carArea.id}">
        <section class="content" style="float: left;width: 1100px"> <!-- .box-body -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">停车区域管理之修改</h3>
                </div>

                <div class="box-body" style="padding-left: 300px">

                    <div style="width: 400px" class="layui-form-item">
                        <label class="layui-form-label" style="padding: 8px 0px;width:100px;">停车区域名称</label>
                        <div class="layui-input-block">
                            <input type="text" name="areaName" required lay-verify="required" placeholder="请输入停车区域名称"
                                   autocomplete="off" class="layui-input" value="${carArea.areaName}">
                        </div>
                    </div>
                    <div style="width: 400px" class="layui-form-item">
                        <label class="layui-form-label" style="padding:10px 0px;width:100px">每小时停车费用</label>
                        <div class="layui-input-block">
                            <input type="text" name="price" required lay-verify="required" placeholder="请输入每小时停车费用"
                                   autocomplete="off" class="layui-input" value="${carArea.price}">
                        </div>
                    </div>
