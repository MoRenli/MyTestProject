...
<div style="height: 619px;background-color: #ecf0f5">
    ...
    <form action="${pageContext.request.contextPath}/stopmanager/updateStopCar">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="padding-left: 300px">
                    ...
                    <div style="width: 400px" class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                        <select class="form-control select2" style="width: 100%" name="carType.id">
                    ...
                    <div style="width: 400px" class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select class="form-control select2" style="width: 100%" name="carPositionNo">
                                <c:forEach items="${carPositionList}" var="carPosition">
                                    <option value="${carPosition.positionNO}">${carPosition.positionNO}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
