...
<div style="height: 619px;background-color: #ecf0f5">
    ...
    <form action="${pageContext.request.contextPath}/userManagerUpdate">
        <input type="hidden" name="id" value="${user.id}">
    <section class="content" style="float: left;width: 1100px"> <!-- .box-body -->
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">用户管理之修改</h3>
            </div>
            ...
            <div class="box-body" style="padding-left: 300px">
                ...
                <div style="width: 400px" class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="trueName" required lay-verify="required" placeholder="请输入姓名"
                               autocomplete="off" class="layui-input" value="${user.trueName}">
                    </div>
                </div>
                <div style="padding-left: 100px">
                    <button type="submit" style="margin-right: 150px" class="layui-btn layui-btn-primary layui-btn-radius">修改
                    </button>
                    <button type="button" class="layui-btn layui-btn-primary layui-btn-radius" onclick="history.back(-1);">返回</button>
                </div>
