                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建"
                                        onclick='location.href="${pageContext.request.contextPath}/carTypeAdd"'>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='delOne(${carType.id})'>删除
                                    </button>
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="${pageContext.request.contextPath}/typemanager/updateShow?carTypeId=${carType.id}"'>
                                        修改
                                    </button>
                                </td>
                            </tr>
...
<script type="text/javascript">
    function delOne(id) {
        if (confirm("您确定要删除吗？")) {
            //执行删除操作
            location.href = "${pageContext.request.contextPath}/typemanager/typeManagerDelete?id=" + id;
        }
    }
</script>
</body>
